                ...
                .then(res => {
                    ...
                    gridInstance = $('#grid').dxDataGrid({
                        ...
                        columns: [
                            ...
                            {
                                caption: 'Departement',
                                dataField: 'departement.nama',
                                calculateCellValue: r => r.departement?.depNama ?? '-'
                            },
                                                ...
                                                Swal.fire({
                                                    ...
                                                    .then(r => {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            url: "{{ route('jabatan.destroy',':id') }}".replace(':id', id),
